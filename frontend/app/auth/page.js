...
function AuthContent() {
  ...
  const handleSubmit = async (ev) => {
    ...
    setErrors({});
    setLoading(true);
    setTimeout(() => { setLoading(false); window.location.href = '/chat'; }, 1200);
  };
        ...
        <div className={styles.leftContent}>
          <div className={styles.leftTop}>
            ...
            <p className={styles.leftSub}>
              {mode === 'login'
                ? 'Sign in to access your personalised study assistant.'
                : 'Create an account to save context and chat history.'}
            </p>
          </div>
...
function GoogleIcon() {
  return (
    <svg width="15" height="15" viewBox="0 0 24 24" fill="none">
      <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="#737373"/>
      ...
      <path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="#737373"/>
    </svg>
  );
}
function GitHubIcon() {
  return (
    <svg width="15" height="15" viewBox="0 0 24 24" fill="var(--text-3)">
